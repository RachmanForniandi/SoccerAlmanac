...
class MatchDetailActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        /*val dao = SubscriberMatchDatabase.getInstance(this)?.subscriberMatchDAO
        ...
        val dataItem = intent?.getSerializableExtra("detailMatch") as? EventsTime
        Log.e("debugBundleDetail", "" + dataItem)

        // dao?.let { LocalRepository(it) }
